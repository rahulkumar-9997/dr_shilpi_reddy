         ...
         <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
               <ol class="breadcrumb">
                  ...
                  <li class="active">
                     <strong>Manage Foundation Category</strong>
                  </li>
               </ol>
            </div>
         </div>
         ...
         <section class="box ">
            <header class="panel_header">
               ...
               <div class="actions panel_actions pull-right">
                  ...
                  <a href="javascript:void(0)" data-foundation-category-popup="true" data-size="sm" data-title="Add New Foundation Category" data-url="{{ route('foundation-category.create') }}" data-bs-toggle="tooltip" class="btn btn-warning btn-sm" data-bs-original-title="Add New Foundation Category">
