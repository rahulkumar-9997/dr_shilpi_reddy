         ...
         <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
               <ol class="breadcrumb">
                  ...
                  <li class="active">
                     <strong>Manage Feature logo</strong>
                  </li>
               </ol>
            </div>
         </div>
      ...
      <div class="col-lg-12">
         <section class="box ">
            <header class="panel_header">
               <h2 class="title pull-left">Manage Feature logo</h2>
                     ...
                     <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                        ...
                        @foreach($data['feature_logo_list'] as $image_list_id)
                           <tr>
                              <td>{{ $sr_no }}</td>
                              <td>
                              <img src="{{ asset('feature-logo/thumb/' . $image_list_id->img_file) }}" style="width: 50px;">
                              </td>
                              <td>
